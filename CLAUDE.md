...
7. Merge worktree into main and push to remote
8. Deploy to vercel only from the clean updated main
9. Clean up any feature/branches or git worktrees that remain.
